...
## 2. 開発経緯（Development History）

- 2025年5月　ブロックチェーン簡易登録アプリの構想を立案。AIによるノーコード開発に着手。  
- 同年5月　「ブロックチェーン簡易登録アプリ」および「ブロックチェーン証明システム」の技術概念を実用新案として特許庁に申請。あわせて名称およびロゴを商標登録済。  
- 同年5月27日　ブロックチェーン簡易登録アプリのプロトタイプをURLベースで限定リリース。  
- 同年6月　外部業者より見積もりを取得。県の新規事業支援部署を通じて弁理士との面談を開始し、現在も継続中。  
- 同年6月〜現在　Spark AI主催「新規事業創出講座」および新規事業プランニング講座を受講し、AI実装・リーンキャンパスを学習中。  
- 同年9月　実用新案補正手続を実施。  
- 同年11月　実用新案第2次補正手続を実施。現在審査中。  
- 同年10月〜現在　Proof of Democracy の理念を基盤に、「天地愛プロジェクト」への統合方針を確定。DAO構想を正式に確立。  
